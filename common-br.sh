...
sudo echo ../common-br.wpa_supplicant >> /etc/wpa_supplicant/wpa_supplicant.conf
...
sudo echo ../common-br.dhcpcd >> /etc/dhcpcd.conf
...
sudo echo ../common-br.dnsmasq >> /etc/dnsmasq.conf
